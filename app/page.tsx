...
export default function Home() {
  return (
    ...
    <main className="flex min-h-fit flex-row items-baseline justify-between p-36">
      <div className="md:container md:mx-auto z-10 w-full max-w-5xl items-center justify-between flex-col font-mono text-lg lg:flex">
        <a className='text-4xl'>
          Matthew Balzano&nbsp;
        </a>
          <br></br>
          <h2 className='text-sm'>Junior Software Engineer</h2>



      </div>
        {/* <div className="fixed bottom-0 left-0 flex h-48 w-full items-end justify-center bg-gradient-to-t from-white via-white dark:from-black dark:via-black lg:static lg:h-auto lg:w-auto lg:bg-none"> */}
        <div className="md:container md:mx-auto z-10 w-full max-w-5xl items-center justify-between flex-col font-mono text-sm lg:flex">
